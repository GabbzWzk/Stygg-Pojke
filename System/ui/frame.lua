...
function frameCreation(name,width,heigth,title)
    if _G[name.."Frame"] == nil then
        ...
        if BadRobot_data.BadRobotUI[name.."Frame"] == nil then
            BadRobot_data.BadRobotUI[name.."Frame"] = {
                color = {
                    r = 16,
                    g = 16,
                    b = 16,
        ...
        if BadRobot_data.BadRobotUI[name.."Frame"] ~= nil and BadRobot_data.BadRobotUI[name.."Frame"].pos ~= nil then
            anchor = BadRobot_data.BadRobotUI[name.."Frame"].pos.anchor or "CENTER"
            x = BadRobot_data.BadRobotUI[name.."Frame"].pos.x or -75
            y = BadRobot_data.BadRobotUI[name.."Frame"].pos.y or -200
        else
            anchor = "CENTER"
            x = 75
            y = 200
        ...
        _G[name.."Frame"].texture:SetTexture(BadRobot_data.BadRobotUI[name.."Frame"].color.r/255,BadRobot_data.BadRobotUI[name.."Frame"].color.g/255,BadRobot_data.BadRobotUI[name.."Frame"].color.b/255,BadRobot_data.BadRobotUI[name.."Frame"].color.a)
        ...
        _G[name.."FrameTitle"]:SetFont(BadRobot_data.BadRobotUI.font,BadRobot_data.BadRobotUI.fontsize+1,"THICKOUTLINE")
        ...
        if BadRobot_data.options[GetSpecialization()] and BadRobot_data.options[GetSpecialization()][name.."Frame"] == false then
            _G[name.."Frame"]:Hide()
        end
        ...
        _G[name.."Frame"]:SetScript("OnReceiveDrag", function(self)
            ...
            BadRobot_data.BadRobotUI[name.."Frame"].pos.x = x
            BadRobot_data.BadRobotUI[name.."Frame"].pos.y = y
            BadRobot_data.BadRobotUI[name.."Frame"].pos.anchor = anchor
        end)
