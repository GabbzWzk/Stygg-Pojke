...
function createTextString(parent,value,x,y,heigth,width)
    ...
    _G[parent..value.."TextFrame"]:SetAlpha(BadRobot_data.BadRobotUI.alpha)
...
function createTitleString(parent,value,x,y)
    ...
    _G[parent..value.."TitleFrame"]:SetAlpha(BadRobot_data.BadRobotUI.alpha)
    --_G[parent..value.."TextFrame"]:Hide()
    ...
    _G[parent..value.."Text"]:SetPoint("TOPLEFT",0,0)
    _G[parent..value.."Text"]:SetAlpha(BadRobot_data.BadRobotUI.alpha)
    _G[parent..value.."Text"]:SetFont(BadRobot_data.BadRobotUI.font,(BadRobot_data.BadRobotUI.fontsize+2)*scale,"THICKOUTLINE")
