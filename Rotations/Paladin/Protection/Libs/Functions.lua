if select(3,UnitClass("player")) == 2 then
  function PaladinProtFunctions()
    ...
    local player,BadRobot_data,GetShapeshiftForm,dynamicTarget = "player",BadRobot_data,GetShapeshiftForm,dynamicTarget
    ...
    function protCore:update()
      ...
      -- Modes
      self.mode.aoe = BadRobot_data["AoE"]
      self.mode.cooldowns = BadRobot_data["Cooldowns"]
      self.mode.defensive = BadRobot_data["Defensive"]
      self.mode.healing = BadRobot_data["Healing"]
      self.mode.rotation = BadRobot_data["Rota"]
      ...
      self.combatLenght = GetTime() - BadRobot_data["Combat Started"]
