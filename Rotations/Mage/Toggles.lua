if select(3, UnitClass("player")) == 8 then
    ...
    function Toggles()
        ...
        -- Start with the generic Toggles
        if  AoEModesLoaded ~= "AoE Modes" then
            AoEModes = {
                ...
                [2] = { mode = "AoE", value = 2 , overlay = "AoE Enabled", tip = "|cff00FF00AoE \n|cffFFDD11Recommended for \n|cffFF0000AoE (5+)", highlight = 0, icon = 1449 }, -- Todo : Hm how do we do single, semi and fullt aoe?
         ...
         -- Cooldowns Button
        if  CooldownsModesLoaded ~= "DPS Cooldowns Modes" then
            CooldownsModes = {
                ...
                [2] = { mode = "On", value = 2 , overlay = "Cooldowns Enabled", tip = "|cff00FF00Cooldowns \n|cffFFDD11Only used if enabled in Settings.", highlight = 1, icon = 55342 }
            };
            CreateButton("Cooldowns",1.5,1)
            CooldownsModesLoaded = "DPS Cooldowns Modes";
        end
        -- Defensive Button
